...
public class Inicio extends javax.swing.JFrame {
    ...
    private void aplicarFuentePersonalizada(Font fuentePersonalizada) {
        ...
        jButton1.setFont(fuentePersonalizada);
        jButton2.setFont(fuentePersonalizada);
        jButton3.setFont(fuentePersonalizada);
        jButton4.setFont(fuentePersonalizada);

        // Aplica la fuente a todos los JLabel
        jLabel2.setFont(fuentePersonalizada);
        jLabel3.setFont(fuentePersonalizada);
        jLabel4.setFont(fuentePersonalizada);

        // Aplica la fuente a los JTextField
        jTextField1.setFont(fuentePersonalizada);
        jTextField2.setFont(fuentePersonalizada);

        // Aplica la fuente al JTextArea
        jTextArea1.setFont(fuentePersonalizada);
    ...
    private void aplicarTamanosDeFuentes(Font fuenteBase) {
       ...
       // Font textoMenu = fuenteBase.deriveFont(20f);    // Tamaño del menu 
        ...
        jButton1.setFont(textoBotones);  // Tamaño 40 para este botón
        ...
        jTextField2.setFont(subtitulo);  // Subtitulo (¿Ya Tienes Cuenta?

        // Aplica la fuente al JTextArea
        jTextArea1.setFont(textoPlano);     // Tamaño 18 para el JTextArea
    }
